...
import LabyInput from './Input.vue'
import LabySwitch from './Switch.vue'
import LabyTable from './Table.vue'
import LabyTab from './Tab.vue'
import LabyTabs from './Tabs.vue'

export { LabyButton, LabyCard, LabyDialog, LabyInput, LabySwitch, LabyTable, LabyTab, LabyTabs, }
export { createDialog as createDialog } from './createDialog'

export default {
  install: Vue => {
    const components = [LabyButton, LabyCard, LabyDialog, LabyInput, LabySwitch, LabyTable, LabyTab, LabyTabs]
